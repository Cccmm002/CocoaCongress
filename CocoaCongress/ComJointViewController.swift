...
class ComJointViewController: UIViewController, CommitteeTabs {
    ...
    func resetData() {
        self.filteredData = Constants.data.comData.filter{ $0.chamber == "joint" }
        self.table.reloadData()
    }
    
}

extension ComJointViewController : UISearchResultsUpdating, UISearchControllerDelegate {
    func updateSearchResults(for searchController: UISearchController) {
        ...
        self.filteredData = Constants.data.comData.filter { ($0.chamber == "joint") && ($0.title.lowercased().contains(searchText)) }
        self.table.reloadData()
    }
...
extension ComJointViewController : UITableViewDelegate {
...
extension ComJointViewController: UITableViewDataSource {
