...
class LegSenateViewController: UIViewController, LegislatorTabs {
    ...
    func resetData() {
        self.filteredData = Constants.data.legisData.filter{ $0.chamber == "senate" }
        buildDic()
...
extension LegSenateViewController : UISearchResultsUpdating, UISearchControllerDelegate {
    func updateSearchResults(for searchController: UISearchController) {
        ...
        self.filteredData = Constants.data.legisData.filter { ($0.chamber == "senate") && ($0.first_name.lowercased().contains(searchText) || $0.last_name.lowercased().contains(searchText)) }
        self.buildDic()
        self.table.reloadData()
    }
...
extension LegSenateViewController : UITableViewDelegate {
...
extension LegSenateViewController: UITableViewDataSource {
